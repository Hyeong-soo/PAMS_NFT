...
class _Profile_PageState extends State<Profile_Page>
  ...
  getactData() async {
    ...
    var schoolactlist = await FirebaseFirestore.instance
        .collection('users')
        .doc(URL)
        .collection('schoolAct')
        .get();
    ...
    var clubactlist = await FirebaseFirestore.instance
        .collection('users')
        .doc(URL)
        .collection('clubAct')
        .get();
    ...
    var volunteerlist = await FirebaseFirestore.instance
        .collection('users')
        .doc(URL)
    ...
    var extraactlist = await FirebaseFirestore.instance
        .collection('users')
        .doc(URL)
        .collection('extraAct')
        .get();
    ...
    var NFT_s = await FirebaseFirestore.instance
        .collection('users')
        .doc(URL)
        .collection('NFT')
        .get();
...
/*
              ...
              child: Container(
                ...
                child: Container(
                  child: ClipPolygon(
                    ...
                    child: NFT.isEmpty // introduce == '1'
                        ? Image.asset('assets/phonix.png',
                        height: 91 * Factor_Height,
                        width: 91 * Factor_Height)
                        : Image.network(Selected_Image,
                        height: 91 * Factor_Height,
                        width: 91 * Factor_Height),
                  ),
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        CupertinoPageRoute(
                            builder: (context) => Profile_Exactly_Page(
                                NFT_In[2 * i][11], 2 * i)));
                  },
                ),
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            NFT[2 * i][0],
                            style: TextStyle(
                                fontSize: 12, fontFamily: 'Spoqa-Bold'),
                          ),
                          Text(
                            NFT[2 * i][2],
                            style: TextStyle(
                                  ...
                                  child: Column(
                                    children: [
                                      Container(
                                          ...
                                          height: 15 * Factor_Height,
                                          child: Image.asset(
                                              'assets/heart (2).png') //: Image.asset('assets/heart (1).png'),
                                      ),
                                      Text(
                                        NFT[2 * i + 1][1].toString(),
                                        style: TextStyle(
                                            fontSize: 10,
                                            fontFamily: 'Spoqa-Medium'),
                                      )
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        NFT[length - 1][0],
                        style:
                        TextStyle(fontSize: 12, fontFamily: 'Spoqa-Bold'),
                      ),
                      Text(
                        NFT[length - 1][2],
                        style: TextStyle(
  ...
  Widget Career() {
    ...
    var act_num = snamelist.length +
        cnamelist.length +
        vnamelist.length +
        enamelist.length; // 전체 활동 개수
    return ListView(
      shrinkWrap: true,
            ...
            children: [
              Container(
                ...
                child: Text(
                  'NFT',
                  style: TextStyle(
                      fontFamily: 'Spoqa-Bold', fontSize: 18 * Factor_Height),
                ),
              ),
              Container(height: 8 * Factor_Height),
              NFT_In.length.isOdd
                  ? odd_Row_Container(NFT_In.length)
                  : even_Row_Container(NFT_In.length),
            ],
          ),
        ),
      ],
      ...
      body: Column(
        ...
        children: [
          ...
          Icon(
            Icons.favorite,
            color: Colors.red,
            size: 23 * Factor_Height,
          ),
          Text(
            NFT[widget.i][1].toString(),
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 14 * Factor_Height),
          ),
          Container(height: 25 * Factor_Height),
          RichText(
          ...
          Container(height: 25 * Factor_Height),
          Text(
            'NFT-ID: ' + NFT_In[widget.i][11],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
          Container(height: 2 * Factor_Height),
          Text(
            'kind: ' + NFT_In[widget.i][8],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
          Container(height: 2 * Factor_Height),
          Text(
            'prize: ' + NFT_In[widget.i][9],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
          Container(height: 2 * Factor_Height),
          Text(
            'host: ' + NFT_In[widget.i][7],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
          Container(height: 2 * Factor_Height),
          Text(
            'day_start: ' + NFT_In[widget.i][5],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
          Container(height: 2 * Factor_Height),
          Text(
            'day_end: ' + NFT_In[widget.i][4],
            style: TextStyle(
                fontFamily: 'Spoqa-Medium', fontSize: 18 * Factor_Height),
          ),
        ],
